...
class ScenarioConfigs():
    ...
    def __init__(self):
        ...
        print('total lists', len(self.all_event_lists), 'informed lists', len(self.informed_event_lists), 'uninformed lists',
              len(self.uninformed_event_lists))
        ...
        for event_name in self.all_event_lists:
            all_event_permutations[event_name] = count_permutations(self.all_event_lists[event_name])
        ...
        self.stages = {
            'a0': {'events': self.all_event_lists, 'params': 'no-op'},
            'i0': {'events': self.informed_event_lists, 'params': 'no-op'},
            'u0': {'events': self.uninformed_event_lists, 'params': 'no-op'},

            'i1': {'events': self.informed_event_lists, 'params': 'defaults'},
            'u1': {'events': self.uninformed_event_lists, 'params': 'defaults'},
            'a1': {'events': self.all_event_lists, 'params': 'defaults'},
        }
