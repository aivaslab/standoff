...
def make_callbacks(save_path, env, batch_size, tqdm_steps, record_every, model, repetition=0, starting_timesteps=0, threads=1, learning_rate=1, args_string=''):
    ...
    checkpoints = CheckpointCallback(save_freq=record_every, save_path=save_path_2, name_prefix='model', save_vecnormalize=True, verbose=0)
...
class TqdmCallback(BaseCallback):
    ...
    def _on_training_start(self):
        self.progress_bar = tqdm(total=self.locals['total_timesteps'], smoothing=0.01)
