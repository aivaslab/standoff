...
def train_model(train_sets, target_label, load_path='supervised/', save_path='', epochs=100,
    ...
    for batch in range(batches):
        ...
        '''for module_name in module_labels.keys():
            ...
            module_output = outputs[module_name].reshape(outputs[module_name].size(0), -1)[:, :module_sizes[module_name]]
            ...
            #print(module_name, module_output.shape, module_target.shape, module_target[0])
        ...
        if record_loss and (((batch) % epoch_length_val == 0) or (batch == batches - 1)):
            ...
            with torch.inference_mode():
                ...
                for inputs, target_labels, _, oracle_inputs, _ in test_loader:
                    ...
                    #print('module keys', module_labels.keys(), module_ranges.keys())
