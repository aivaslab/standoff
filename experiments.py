...
def experiments(todo, repetitions, epochs=50, batches=5000, skip_train=False, skip_calc=False, batch_size=64, desired_evals=5,
    ...
    if 's' in todo:
        ...
        names = ['exp_153', 'exp_151', 'exp_154', 'exp_159']#['exp_53']#, 'exp_51', 'exp_54',]
        ...
        for dataset in names:
            print(dataset)
            cur_regimes = {'exp_154': mixed_regimes, 'exp_151': single_regimes, 'exp_153': regimes, 'exp_159': hregime}[dataset]
...
if __name__ == '__main__':
    experiments([59], repetitions=1, batches=10000, skip_train=False, skip_eval=False, skip_calc=True, skip_activations=False,
